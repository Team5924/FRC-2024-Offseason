...
public class SetIntakeState extends InstantCommand {
  ...
  private final boolean otherStuffForFloor;

  public SetIntakeState(Intake intake, Elevator elevator, Feeder feeder, IntakeState state, boolean otherStuffForFloor) {
    this.intake = intake;
    this.elevator = elevator;
    this.feeder = feeder;
    this.state = state;
    this.otherStuffForFloor = otherStuffForFloor;
  ...
  public void initialize() {
    ...
    } else if (state == IntakeState.FLOOR && otherStuffForFloor) {
